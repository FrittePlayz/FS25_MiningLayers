...
function InGameMenuMiningLayersFrame:onFrameClose()
    ...
    -- ★ Speichern-Falle (Oreo-Fall vom 11.08.): Wer die Seite mit offenen Aenderungen
    -- verlaesst, verliert sie lautlos - beim naechsten Oeffnen baut buildContent() wieder
...
---den Boden abkippen lassen - dieser Karte sind die Bodenplaetze ausgegangen.
---Bewusst ein Zeichen, das in jeder Schriftart sitzt - Sonderzeichen fallen in
---FS-Menues gern aus.
...
function InGameMenuMiningLayersFrame:onClickSaveLayers()
    ...
    -- ★ Selbsthilfe-Zeile (Oreo-Fall vom 11.08.): Er hatte DIRT+STONE eingestellt, gegraben
    -- wurde mit unseren Standardschichten, und im Log stand `0 benannte Zone(n)` - aber
